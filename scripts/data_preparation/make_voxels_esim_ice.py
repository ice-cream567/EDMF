...
parser.add_argument("--input_path", default="/home/ice/MFHI/datasets_MFHI/GOPRO_rawevents/train", help="Path to hdf5 file")
parser.add_argument("--save_path", default="/home/ice/MFHI/datasets_MFHI/GOPRO_3d111debug/train")
parser.add_argument("--voxel_method", default="ice_esim", help="ice_esim, ice_real_data")
...
def main():
    ...
    data_augment = {}
    dataset_kwargs = {'transforms': data_augment, 'voxel_method': voxel_method, 'num_bins': num_bins,'window_size': window_size,
