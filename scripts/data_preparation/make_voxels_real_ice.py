...
parser.add_argument("--input_path", default="/home/ice/MFHI/datasets_MFHI/REBlur_rawevents/test", help="Path to hdf5 file")
parser.add_argument("--save_path", default="/home/ice/MFHI/datasets_MFHI/REBlur_3d10/test")

parser.add_argument("--voxel_method", default="ice_real_data", help="SCER_esim, ice_real_data, SBT, All_accumulate=SBT + bin=1")
...
def main():
    ...
    data_augment = {}
    dataset_kwargs = {'transforms': data_augment, 'voxel_method': voxel_method, 'num_bins': num_bins, 'window_size': window_size, 'return_gt_frame':has_gt_frame,
